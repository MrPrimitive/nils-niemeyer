...
export class HomeAnimation {
  ...
  static ANIMATION_HOME_BOUNCING_ARROW: AnimationTriggerMetadata =
  ...
  static ANIMATION_HOME_FADE_TEXT: AnimationTriggerMetadata =
  ...
  static ANIMATION_HOME_SCROLL: AnimationTriggerMetadata =
    trigger('scroll', [
      transition('* => *', [
        query(':leave', [
          stagger(50, [
